...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {clock_i}];  # "GCLK"
set_property PACKAGE_PIN Y11 [get_ports {aes_on_o}];  # "JA1"

# ----------------------------------------------------------------------------
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {data_o[0]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {data_o[1]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {data_o[2]}];  # "LD2"
set_property PACKAGE_PIN U22 [get_ports {data_o[2]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {data_o[3]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {data_o[4]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {data_o[5]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {data_o[6]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {data_o[7]}];  # "LD7"


# ----------------------------------------------------------------------------
# User Push Buttons - Bank 34
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {start_i}];  # "BTNC"
set_property PACKAGE_PIN R16 [get_ports {reset_i}];  # "BTND"


# ----------------------------------------------------------------------------
# User DIP Switches - Bank 35
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {sel_i[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {sel_i[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {sel_i[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {sel_i[3]}];  # "SW3"
