...
targets -set -nocase -filter {name =~"APU*" && jtag_cable_name =~ "Digilent Zed 210248530742"} -index 0
...
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zed 210248530742"} -index 0
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zed 210248530742"} -index 0
