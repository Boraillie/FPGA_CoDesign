...
HD_PWD='D:/Documents/Cours/EMSE/3A/Embedded_Systems/FPGA_CoDesign/Projet_AES_2018/ip_repo/edit_AES_IP_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_IP_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AES_IP_v1_0.tcl -notrace
